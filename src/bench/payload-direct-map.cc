...
class PayloadDirectWorkload : public Workload {
 public:
  PayloadDirectWorkload(librados::IoCtx *ioctx, size_t stripe_width,
...
int main(int argc, char **argv)
{
  ...
  PayloadDirectWorkload workload(&ioctx, stripe_width,
